...
[CustomPropertyDrawer(typeof(ObstaclePool))]
public class ObstaclePoolPropertyDrawer : PoolPropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        SerializedProperty numberOfElementsProperty = property.FindPropertyRelative("obstaclePrefab");
